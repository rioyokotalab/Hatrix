...
namespace Hatrix {
  ...
  public:
    double diameter;
    int ndim, num_particles, start_index, stop_index;
    ...
    Box();
    Box(double _diameter, double center_x, int _start_index, int _stop_index,
        std::string _morton_index, int _num_particles);
    Box(double diameter, double center_x, double center_y, double start_index,
        double stop_index, std::string _morton_index, int num_particles);
