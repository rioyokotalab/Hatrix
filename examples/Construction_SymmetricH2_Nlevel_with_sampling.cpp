...
int main(int argc, char ** argv) {
  ...
  // }
  const bool sample_ELSES = (geom_type == 3 && kernel_type == 2);
  domain.build_sample_bodies(sample_self_size, sample_far_size, sampling_algo, sample_ELSES);
