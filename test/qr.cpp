...
TEST_P(HouseholderQRCompactWYTests, HouseholderQRCompactWY) {
  ...
  Hatrix::Matrix YT(Y);
  Hatrix::triangular_matmul(T, YT, Hatrix::Right, Hatrix::Upper, false, false, 1.);
...
TEST_P(ApplyBlockReflectorTests, ApplyBlockReflector) {
  ...
  Hatrix::Matrix YT(Y);
  Hatrix::triangular_matmul(T, YT, Hatrix::Right, Hatrix::Upper, trans, false, 1.);
...
INSTANTIATE_TEST_SUITE_P(
  LAPACK, HouseholderQRCompactWYTests,
  testing::Values(
